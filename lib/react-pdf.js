    ...
    _createClass(PDF, [{
        ...
        value: function componentDidMount() {
            if (this.props.worker === false) {
                _pdfjsDist2.default.GlobalWorkerOptions.disableWorker = true;
            }
        ...
        value: function loadDocument(props) {
            ...
            if (props.data || props.url) {
                this.cleanup();
                // convert to bluebird
                this._pdfPromise = _bluebird2.default.resolve(_pdfjsDist2.default.getDocument(props.data ? { data: props.data } : props.url)).then(this.completeDocument).catch(_pdfjsDist2.default.MissingPDFException, function () {
